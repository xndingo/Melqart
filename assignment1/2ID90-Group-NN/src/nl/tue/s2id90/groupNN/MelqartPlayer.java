...
public class MelqartPlayer extends DraughtsPlayer {
     ...
     */
    public static double evaluate(DraughtsState ds){
        double total = 0;
    ...
    public static double addValue(int r, int c, boolean isWhite, DraughtsState ds){
    ...
    public static double calcPlayground (int y, int x, boolean white){
