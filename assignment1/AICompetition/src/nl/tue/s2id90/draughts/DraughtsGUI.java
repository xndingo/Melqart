    ...
    implements GameGUI<DraughtsState,DraughtsPlayer,Move>
{
    ...
    JButton swapButton;
    private MoveListModel moves = new MoveListModel(new ArrayList<Move>());
    ...
    public List<JComponent> getPanels() {
        if (moveList == null) {
            ...
            allowEditingCheckBox.addActionListener(new ActionListener() {
                @Override
    ...
    private void reset(Game game, BoardState bs, boolean clearMoves) {
        ...
        if (clearMoves) {
            ...
            moveList.setModel(moves=new MoveListModel((BoardState) bs.clone(), new ArrayList<Move>()));
        }
        updatePieceCount(ds);
